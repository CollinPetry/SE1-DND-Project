...
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I idolize a particular hero of my faith, and constantly refer to that person’s deeds and example." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I can find common ground between the fiercest enemies, empathizing with them and always working toward peace." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I see omens in every event and action. The gods try to speak to us, we just need to listen." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "Nothing can shake my optimistic attitude." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I quote (or misquote) sacred texts and proverbs in almost every situation." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I am tolerant (or intolerant) of other faiths and respect (or condemn) the worship of other gods." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’ve enjoyed fine food, drink, and high society among my temple’s elite. Rough living grates on me." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’ve spent so long in the temple that I have little practical experience dealing with people in the outside world." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Acolyte";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I fall in and out of love easily, and am always pursuing someone." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I have a joke for every occasion, especially occasions where humor is inappropriate." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "Flattery is my preferred trick for getting what I want." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m a born gambler who can’t resist taking a risk for a potential payoff." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I lie about almost everything, even when there’s no good reason to." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "Sarcasm and insults are my weapons of choice." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I keep multiple holy symbols on me and invoke whatever deity might come in useful at any given moment." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I pocket anything I see that might have some value." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Charlatan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I always have a plan for what to do when things go wrong." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I am always calm, no matter what the situation. I never raise my voice or let my emotions control me." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "The first thing I do in a new place is note the locations of everything valuable—or where such things could be hidden." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I would rather make a new friend than a new enemy." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I am incredibly slow to trust. Those who seem the fairest often have the most to hide." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I don’t pay attention to the risks in a situation. Never tell me the odds." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "The best way to get me to do something is to tell me I can’t do it." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I blow up at the slightest insult." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Criminal";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I judge people by their actions, not their words." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "If someone is in trouble, I’m always ready to lend help." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "When I set my mind to something, I follow through no matter what gets in my way." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I have a strong sense of fair play and always try to find the most equitable solution to arguments." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m confident in my own abilities and do what I can to instill confidence in others." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "Thinking is for other people. I prefer action." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I misuse long words in an attempt to sound smarter." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I get bored easily. When am I going to get on with my destiny? as trait_description", 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Folk Hero";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I believe that anything worth doing is worth doing right. I can’t help it— I’m a perfectionist. as trait_description", 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m a snob who looks down on those who can’t appreciate fine art." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I always want to know how things work and what makes people tick." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m full of witty aphorisms and have a proverb for every occasion." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m rude to people who lack my commitment to hard work and fair play." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I like to talk at length about my profession." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I don’t part with my money easily and will haggle tirelessly to get the best deal possible." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Guild Artisan";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m well known for my work, and I want to make sure everyone appreciates it. I’m always taken aback when people haven’t heard of me." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’ve been isolated for so long that I rarely speak, preferring gestures and the occasional grunt" as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I am utterly serene, even in the face of disaster." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "The leader of my community had something wise to say on every topic, and I am eager to share that wisdom." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I feel tremendous empathy for all who suffer." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m oblivious to etiquette and social expectations." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I connect everything that happens to me to a grand, cosmic plan." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I often get lost in my own thoughts and contemplation, becoming oblivious to my surroundings." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I am working on a grand philosophical theory and love sharing my ideas." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Hermit";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "My eloquent flattery makes everyone I talk to feel like the most wonderful and important person in the world" as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "The common folk love me for my kindness and generosity." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "No one could doubt by looking at my regal bearing that I am a cut above the unwashed masses." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I take great pains to always look my best and follow the latest fashions." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I don’t like to get my hands dirty, and I won’t be caught dead in unsuitable accommodations." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "Despite my noble birth, I do not place myself above other folk. We all have the same blood." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "My favor, once lost, is lost forever." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "If you do me an injury, I will crush you, ruin your name, and salt your fields." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Noble";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m driven by a wanderlust that led me away from home" as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I watch over my friends as if they were a litter of newborn pups." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I once ran twenty-five miles without stopping to warn to my clan of an approaching orc horde. I’d do it again if I had to." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I have a lesson for every situation, drawn from observing nature." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I place no stock in wealthy or well-mannered folk. Money and manners won’t save you from a hungry owlbear." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m always picking things up, absently fiddling with them, and sometimes accidentally breaking them." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I feel far more comfortable around animals than people." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I was, in fact, raised by wolves." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Outlander";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I use polysyllabic words that convey the impression of great erudition." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’ve read every book in the world’s greatest libraries— or I like to boast that I have." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m used to helping out those who aren’t as smart as I am, and I patiently explain anything and everything to others." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "There’s nothing I like more than a good mystery." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m willing to listen to every side of an argument before I make my own judgment." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I ... speak ... slowly ... when talking ... to idiots, ... which ... almost ... everyone ... is .. compared ... to me." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I am horribly, horribly awkward in social situations." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m convinced that people are always trying to steal my secrets." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sage";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "My friends know they can rely on me, no matter what." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I work hard so that I can play hard when the work is done. as trait_description", 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I enjoy sailing into new ports and making new friends over a flagon of ale." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I stretch the truth for the sake of a good story." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "To me, a tavern brawl is a nice way to get to know a new city." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I never pass up a friendly wager." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "My language is as foul as an otyugh nest." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Sailor";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m always polite and respectful." as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m haunted by memories of war. I can’t get the images of violence out of my mind." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’ve lost too many friends, and I’m slow to make new ones." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I’m full of inspiring and cautionary tales from my military experience relevant to almost every combat situation" as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I can stare down a hell hound without flinching." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I enjoy being strong and like breaking things." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I have a crude sense of humor." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I face problems head-on. A simple, direct solution is the best path to success." as trait_description, 8 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Soldier";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I hide scraps of food and trinkets away in my pockets" as trait_description, 1 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I ask a lot of questions." as trait_description, 2 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I like to squeeze into small places where no one else can get to me." as trait_description, 3 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I sleep with my back to a wall or tree, with everything I own wrapped in a bundle in my arms." as trait_description, 4 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I eat like a pig and have bad manners." as trait_description, 5 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I think anyone who’s nice to me is hiding evil intent." as trait_description, 6 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
SELECT b.background_id as background_id, "I don’t like to bathe." as trait_description, 7 as trait_roll
FROM backgrounds as b
WHERE b.background_name="Urchin";
INSERT INTO suggested_traits (background_id,trait_description,trait_roll)
